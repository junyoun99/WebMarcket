...
public class WesternHandler implements CommandHandler {
	@Override
	public String process(HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		try {
			...
			String sql = "select * from recipe where kind = 'WesternFood' ORDER BY regdate desc";
