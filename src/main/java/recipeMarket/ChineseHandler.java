...
public class ChineseHandler implements CommandHandler {
	@Override
	public String process(HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		try {
			...
			String sql = "select * from recipe where kind = 'ChineseFood' ORDER BY regdate desc";
