...
public class KoreanHandler implements CommandHandler {
	...
	public String process(HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		try {
			...
			String sql = "select * from recipe where kind = 'KoreanFood' ORDER BY regdate desc";
